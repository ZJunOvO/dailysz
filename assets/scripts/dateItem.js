...
var l = (function (t) {
    ...
    e.prototype.setLocked = function (t) {
        t
            ? ((this.bg.spriteFrame = this.bgTypes[1]),
              (this.dateLb.node.color = o.color2),
              (this.dateLb.node.opacity = 180))
            : ((this.bg.spriteFrame = this.bgTypes[0]),
              (this.dateLb.node.color = o.color1),
    ...
    e.prototype.setFinish = function (t) {
        ...
        t &&
            ((this.bg.spriteFrame = this.bgTypes[2]),
            (this.dateLb.node.color = cc.Color.WHITE),
            (this.dateLb.node.opacity = 255));
    };
