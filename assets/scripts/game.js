...
(function (t) {
    (t[(t.None = 0)] = "None"),
        (t[(t.HeadRow = 1)] = "HeadRow"),
        (t[(t.HeadCol = 2)] = "HeadCol"),
        (t[(t.Grid = 3)] = "Grid");
})(l || (l = {}));
(function (t) {
...
(function (t) {
    (t.showBtns = "showBtns"),
        (t.hideBtns = "hideBtns"),
        (t.gameLose = "gameLose"),
        (t.gameRelife = "gameRelife"),
        (t.gameWin = "gameWin"),
        (t.gameWinFailSf = "gameWinFailSf"),
        (t.openItemSelect = "openItemSelect"),
...
var K = {2e4: "点击显示格子内容", 20001: "点击随机显示\n3个格子内容", 20002: "点击显示一行\n或是一列格子内容"};
var Y = (function (t) {
    function e() {
        ...
        e.soundIdx = 1;
        e.items = [
            {icon: "notice", tip: K[2e4], count: 0, itemMax: -1, itemCur: 0},
            {icon: "random_notice", tip: K[20001], count: 0, itemMax: -1, itemCur: 0},
            {icon: "full_row_col", tip: K[20002], count: 0, itemMax: -1, itemCur: 0}
        ];
        e.eventFunc = null;
        e.raceRefreshPop = [];
        e.selectData = {row: -1, col: -1};
        return e;
    }
    var o;
    __extends(e, t);
    ...
    e.prototype.onLoad = function () {
        ...
        if (((this.byGuide = _global.default.byGuide), delete _global.default.byGuide, _global.default.padScale)) {
            ...
            if (
                ((this.heartInfinity.x -= o),
                (this.norClock.parent.x -= o),
                (this.clockWarn.width += 2 * o),
                this.hearts.forEach(function (t) {
                    t.node.x -= o;
                }),
                (this.heartBgNode.x -= o),
                e.removeComponent(cc.Widget),
        ...
        _idx.platform.string() == _pConst.PFCode.Alipay &&
            this.scheduleOnce(function () {
                (t.heartInfinity.parent.y -= _mySafeArea.getSafeAreaRect().yMin),
                    (t.topSp.node.y -= _mySafeArea.getSafeAreaRect().yMin);
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (s) {
                switch (s.label) {
                    case 0:
                        return this.byGuide
                            ? (this.clockWarn.destroy(),
                              (this.stopPraNode.x = 0),
                              (t = this.node),
                              (e = new cc.Node("guideOthers")),
                              (this.guideSteps = [
                                  {
                                      yIdx: 3,
                                      glows: [[0, 5]],
                                  ...
                                  {yIdx: 2, glows: [[1, 3]]},
                                  {
                                      ...
                                      content:
                                          "这行有3个1，那么在它们的中间必须有2个空白块的。\n       1+1+1+2=5。刚好占满整行啦。给他们上色吧。"
                                  },
                                  {yIdx: 0, glows: [[1, 3]], content: "又找到3个连续的涂色块！"},
                                  {
                                      yIdx: 4,
                                      glows: [
                                          [1, 1],
                              ...
                              (this.guideCurStep = -1),
                              (this.guideMaxStep = this.guideSteps.length - 1),
                              [4, _res.default.ins.lPre("prefab/game/gridGlow")])
                            : [3, 4];
                    case 1:
                    ...
                    case 2:
                        return (
                            (a = c.guideNpc = u.apply(l, [s.sent()])).setPosition(380, 610),
                            ...
                            (p = a.getChildByName("dialog")),
                            (this.guideNpcAni = p.getComponent(cc.Animation)),
                            (this.guideNpcLbl = p.getChildByName("content").getComponent(cc.Label)),
                            (d = this.guideFinger = new cc.Node("guideFinger")).setAnchorPoint(0.1, 0.91),
                            _res.default.ins.lSF("common/shouzhi", d.addComponent(cc.Sprite)),
                            e.addChild(d),
                            e.addChild(a),
                            e.setPosition(this.map_node_.position),
                            e.setAnchorPoint(0, 0),
                            (t.getChildByName("up").active = !1),
                            (f = t.getChildByName("down")).children.forEach(function (t) {
                                t.active = !1;
                            }),
                            (this.guideFingerTogY = this.oxTagAni.node.y + f.y - this.map_node_.y),
                            (t.getChildByName("bg").getChildByName("winBg").active = !0),
                            ((g = this.guideMask = new cc.Node("guideMask")).addComponent(cc.Mask).inverted = !0),
                            (y = this.guideMaskBg = new cc.Node("mask")),
                            (m = y.addComponent(cc.Sprite)),
                            [4, _res.default.ins.lSF("common/default_sprite_splash")]
                        );
                    case 3:
                        (m.spriteFrame = s.sent()),
                            y.addComponent(cc.BlockInputEvents),
                            (y.color = cc.Color.BLACK),
                            (y.opacity = 100),
                            this.scheduleOnce(function () {
    ...
    e.prototype.updateGuideStep = function () {
        ...
        if (((this.oxTagAni.node.active = 2 == e || 5 == e), d))
            (r[0].active = !1),
                (i.active = !1),
            ...
            var D = void 0 !== l;
            if (
                (I ? ((S = m + c * y + y / 2 + g.x), (b = y)) : D && ((T = l * y + y / 2 + g.y), (w = y)),
                o.setPosition(S, T),
                o.setContentSize(b, w),
                f.setPosition(-S, -T),
                u)
            )
                for (var P = 0, k = u.length; P < 3; P++) {
                    var R = r[P];
                    if ((R.active = P < k)) {
                        var N = u[P];
                        var C = N[0];
                        ...
                        var E = void 0;
                        I
                            ? ((M = 110), (L = O * y + 30), (A = m + c * y - 15), (E = C * y + y / 2))
                            : D && ((L = 110), (M = O * y + 30), (A = m + C * y - 15), (E = l * y + y / 2));
            ...
            if (p) {
                if (1 == p) {
                    ...
                    B = Math.abs(311) / 200;
                    cc.tween(i)
                        .set({active: !0, opacity: 0, x: 212, y: E, scale: 1})
                        .to(17 / 30, {opacity: 255})
                        .to(B, {x: 523})
                        .to(17 / 30, {opacity: 0})
                        .union()
                        .repeatForever()
                    ...
                    (E = this.guideFingerTogY),
                        (A = 2 == p ? 400 : 330),
                        (A += this.oxTagAni.node.x),
                        cc
                            .tween(i)
                            .set({active: !0, x: A, y: E, scale: 1, opacity: 255})
                            .to(0.5, {scale: 1.2})
            ...
            return __generator(this, function (s) {
                switch (s.label) {
                    case 0:
                        switch (
                            ((u = "normal"),
                            (d = cc.assetManager.getBundle("resSps") || cc.assetManager.getBundle("chapter")),
                            (f = o.type))
                        ) {
                    ...
                    case 1:
                        return (
                            (T = _levelMgr.default.ins),
                            (R = T.getPuzzleInfo()) && ((a = R.size), (l = T.getPuzzleData())),
                            (g = _pInfo.default.ins.getPuzzleLvl()),
                            (m =
                                (null ===
                                    (n =
                                        null ===
                                            (e =
                                                null === (t = _cfgMgr.default.serverCfg) || void 0 === t
                                                    ? void 0
                                                    : t.more_set) || void 0 === e
                                            ? void 0
                                            : e.protect_times) || void 0 === n
                                    ? void 0
                                    : n.val) || 10),
                            (_ =
                                (null ===
                                    (c =
                                        null ===
                                            (r =
                                                null === (i = _cfgMgr.default.serverCfg) || void 0 === i
                                                    ? void 0
                                                    : i.more_set) || void 0 === r
                                            ? void 0
                                            : r.protect_charter) || void 0 === c
                                    ? void 0
                                    : c.val) || 30),
                            g <= m ? (this.infinityLife = !0) : g < _ && (this.relifeTime = -1),
                            (this.getBtnsp.string = "下一关"),
                            [3, 12]
                        );
                    case 2:
                        (p = 1),
                            (u = "normal"),
                            (this.norClock.parent.active = !0),
                            (this.heartsNum = 1),
                            (this.raceTime = 31),
                            (this.raceMaxDenstiy = 0.85),
                            (this.raceMinDenstiy = 0.7),
                            (this.raceDensity = this.raceMaxDenstiy),
                            (this.raceRefeshTime = -1),
                            (this.raceFromX = 180),
                            (this.raceAllX = this.raceFromX - 70),
                            (a = 10),
                            (l = new _creator.default().getRandomData(a, this.raceMaxDenstiy)),
                            _festivalMgr.default.ins.updPro(_festivalMgr.fesTaskKey.raceTimes, 1),
                            (b = this.items);
                        try {
                    ...
                    case 3:
                        return (
                            (a = _global.default.freedomSize),
                            (l = new _creator.default().getRandomData(a, this.raceMaxDenstiy, 5)),
                            [3, 12]
                        );
                    case 4:
                        return (
                            _idx.platform.reportEvent(_idx.ERepEvt.beginPractice),
                            (this.infinityLife = !0),
                            (T = _levelMgr.default.ins),
                            (I = this.byGuide ? 1 : T.getPracticeId()),
                            (this.practiceId = I),
                            (R = T.getPuzzleInfo(!0, I)) && ((a = R.size), (l = T.getPuzzleData(!0, I))),
                            (this.getBtnsp.node.parent.active = !1),
                            (this.stopPraNode.active = !0),
                            [3, 12]
                        );
                    case 5:
                        return (
                            (k = _festivalMgr.default.ins),
                            (R = k.getFesPuzzleInfo()) && ((a = R.size), (l = k.getFesPuzzleData())),
                            (this.getBtnsp.string = "返回主页"),
                            k.isJigsawMax(),
                            [3, 12]
                        );
                    case 6:
                        ...
                        switch (
                            ((A = this.cons2Lbl.node.parent),
                            (B = A.parent.getChildByName("top")),
                            (F = B.getChildByName("cha")),
                            (A.getChildByName("midLblL").getComponent(cc.Label).string = "通关时间"),
                            (A.getChildByName("midLblR").getComponent(cc.Label).string = "通关人数"),
                            (A.getChildByName("nor").active =
                                B.getChildByName("nor").active =
                                this.consLbl.node.parent.active =
                                    !1),
                            (A.getChildByName("cha").active = F.active = this.useTimeLbl.node.active = !0),
                            _res.default.ins.lSF("game/chaTitle", F.getComponent(cc.Sprite)),
                            (this.rewItems.node.parent.y = -325),
                            (this.chaTime = 0),
                            (V = o.challageData),
                            (U = V.date),
                            (z = U.year),
                            ...
                            (G = U.day),
                            (J = 1e4 * z + 100 * H + G),
                            (W = f in _pInfo.challengeType && V.type ? V.type : _pInfo.challengeType.tree),
                            (q = void 0),
                            W != _pInfo.challengeType.worm &&
                                ((a = 10 != (a = V.size) || 15 != a ? 15 : a),
                                (K = V.denstiy < 0.2 || !V.denstiy ? null : V.denstiy),
                                (q = new _creator.default(J)),
                                (l = q.getRandomData(a, K || 0.75, 5))),
                            (Y = q ? q.getRandomIntBetween.bind(q) : _com.default.ins.rad),
                            (X = void 0),
                            W)
                        ) {
                    ...
                    case 7:
                        return (
                            ...
                            ($ = Z.data),
                            (a = Q),
                            (l = new Array(Math.pow(a, 2))).fill(0),
                            (tt = this.wormData = {counts: [], sps: []}),
                            (et = function (t, e) {
                                var o = t - e;
                                return o < 0 ? (-1 == o ? 1 : 0) : 1 == o ? 3 : 2;
                            }),
                            (ot = 0),
                            [4, _res.default.ins.lPre("prefab/game/wormSp")]
                        );
                    case 8:
                        return (
                            (nt = s.sent()) &&
                                (((it = new cc.Node("wormSps")).width = 500),
                                (it.height = 200),
                                (it.x = 100),
                                ((rt = it.addComponent(cc.Layout)).type = cc.Layout.Type.HORIZONTAL),
                                (rt.resizeMode = cc.Layout.ResizeMode.CHILDREN),
                                this.topSp.node.addChild(it)),
                            $.forEach(function (t) {
                                var e;
                                var o;
                                var n;
                                ...
                                t.forEach(function (f) {
                                    (e = t[d - 1]),
                                        ...
                                        u && p
                                            ? (i && a) || (r && s)
                                                ? ((n = i && a ? 90 : 0), (c = 2))
                                                : ((n = i && r ? 0 : i && s ? 270 : s && a ? 180 : 90), (c = 3))
                                            : ((c = p ? 0 : 1), (n = r ? 0 : a ? 90 : s ? 180 : 270)),
                                        (tt[f] = {i: ot, tex: c, dir: n}),
                                        (l[f] = 1),
                                        d++;
                                });
                                ot++;
                    ...
                    case 9:
                        return (
                            ...
                            (st = Math.ceil(X / 2)),
                            (ct = X - st),
                            (at.minRow = Y(0, a - st - 1)),
                            (at.minCol = Y(0, a - ct - 1)),
                            (at.maxRow = at.minRow + st + 1),
                            (at.maxCol = at.minCol + ct + 1),
                            d.preload("game/hedge/mask", cc.SpriteFrame),
                    ...
                    case 10:
                        for (
                            X = V.count || 3, lt = this.iceData = {}, ut = lt.rHints = [], pt = lt.cHints = [], dt = [];
                            X;
                            ...
                            (ht = Y(1, a - 2)),
                                ...
                                (gt = (a - ht - 1) * a + ft),
                                -1 == dt.indexOf(gt) &&
                                    (dt.push(gt, gt - 1, gt + 1, gt + a, gt - a),
                                    (lt[gt] = 1),
                                    (ut[ht] = (ut[ht] || 0) + 1),
                                    (pt[ft] = (pt[ft] || 0) + 1),
                                    X--);
                        return (
                            (dt = null),
                            d.preload("game/ice/mask", cc.SpriteFrame),
                            d.preload("game/ice/pit", cc.SpriteFrame),
                            cc.assetManager.loadBundle("prefab", function (t, e) {
                    ...
                    case 12:
                        if (1 == this.heartsNum || this.infinityLife) {
                            for (yt = 0, mt = this.hearts; yt < 3; yt++)
                                (vt = mt[yt].node),
                                    this.infinityLife
                                        ? (2 == yt && ((vt.active = !0), vt.setPosition(mt[0].node.position)),
                                          (vt.active = 2 == yt))
                                        : (vt.active = 0 == yt);
                        ...
                        if (
                            ((u = "game/" + u + "/"),
                            (_t = _pInfo.default.ins.getUsingSkin().bg),
                            (bt = p ? 1 : _t),
                        ...
                        return this.byGuide
                            ? [2]
                            : ((Pt = _pInfo.default.ins.getUsingSkin().role),
                              cc.assetManager.loadBundle("prefab", function (t, e) {
                                  t ||
                                      e.load("skin/girl" + Pt, cc.Prefab, function (t, n) {
                                          if (!t && kt.node && kt.node.isValid) {
                                              var i = cc.instantiate(n);
                                              var r = (kt.topGirlSk = i.getComponent(sp.Skeleton));
                                              if (p)
                                                  e.load("prefab/game/goose", cc.Prefab, function (t, e) {
                                                      if (!t && kt.node && kt.node.isValid) {
                                                          var o = kt.topSp;
                                                          kt.downSp;
                                                  ...
                                                  if (
                                                      (i.setPosition(a, -20),
                                                      kt.topSp.node.addChild(i),
                                                      f === _pInfo.gameType.challenge)
                                                  ) {
                                                      var s = o.challageData;
                                                      (f in _pInfo.challengeType && s.type
                                                          ? s.type
                                                          : _pInfo.challengeType.tree) === _pInfo.challengeType.worm &&
                                                          (i.scaleX = -i.scaleX);
                                                  }
                                                  r.animation = h.idle;
            ...
            return __generator(this, function (s) {
                switch (s.label) {
                    case 0:
                        for (
                            t = o.type,
                                e = t == _pInfo.gameType.race,
                                n = t == _pInfo.gameType.practice,
                                i = 67,
                                this.fontSize = 36,
                                r = 0;
                            r < this.rows_;
                        ...
                        switch (
                            ...
                            (y = 5),
                            (m = 1),
                            (_ = 1 - (0.07 / 45) * (i - 67.5)) < 0.93 ? (_ = 0.93) : _ > 1 && (_ = 1),
                            (b = 1),
                            (S = 172),
                            d)
                        ) {
                        ...
                        return (
                            _global.default.padScale && !this.byGuide && ((f -= 50), (y -= 50)),
                            this.map_node_.setPosition(h, f),
                            (this.gridBgSp.node.scale = _),
                            (this.selectMaskBg.scale = _),
                            (y -= this.downNode.y),
                            (T = this.itemSelectEff.parent.children[0]).setPosition(g, y),
                            T.setScale(m),
                            (T.children[0].y += this.downNode.y),
                            (this.gridSize = w / this.rows_),
                            (this.gridsStartX = S),
                            (this.hintScale = b),
                            (this.hintWidth = i),
                            [4, this.addHeads()]
                    ...
                    case 3:
                        return (
                            s.sent(),
                            !n && _idx.platform.startVideoRecord(),
                            (D = _pInfo.default.ins),
                            (P = D.getIsFirstRaceTip()),
                            e && !P
                                ? (D.setFirstRaceTip(!0),
                                  (this.canTouch = !1),
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (s) {
                switch (s.label) {
                    case 0:
                        for (
                            this.rowHeadNums.length = this.colHeadNums.length = 0,
                                this.rowHeadBegins.length = this.colHeadBegins.length = 0,
                                this.gridHeadColVec.length = this.gridHeadRowVec.length = 0,
                                this.rowHintsParent.removeAllChildren(),
                                this.colHintsParent.removeAllChildren(),
                                t = 1,
                                a = 0;
                            a < this.rows_;
                            a++
                        ...
                        if (
                            (o.type == _pInfo.gameType.race && t < 3 && (t = 3),
                            this.byGuide
                                ? (this.hintHeight = 85)
                                : (this.hintHeight = 5 == this.rows_ ? 105 : 70 + 30 * (t - 2)),
                            !(r = o.challageData))
                        )
                            return [3, 5];
                        switch (r.type) {
    ...
    e.prototype.beginAni = function (t, e) {
        ...
        cc.tween(this.tilesParent).to(0.2, {opacity: 255}).start();
        cc.tween(this.colHintsParent).set({y: -e}).to(0.2, {y: 0}).start();
        cc.tween(this.rowHintsParent).set({x: t}).to(0.2, {x: 0}).start();
        var n = o.type;
        n == _pInfo.gameType.race
            ? this.raceCountDown()
            : n == _pInfo.gameType.challenge
            ? this.chaCD()
            : this.commonCD();
    };
    ...
    e.prototype.resetCD = function () {
        ...
        if (t) {
            t.stop();
            var e = t.node;
            cc.tween(e).to(0.2, {y: 5, angle: 0}).start();
    ...
    e.prototype.raceCountDown = function () {
        this.hasCountDown
            ? (this.raceTime = 31)
            : ((this.hasCountDown = !0), this.schedule(this._raceCoundDown, 1, cc.macro.REPEAT_FOREVER));
    ...
    e.prototype._raceCoundDown = function (t, e) {
        if (this.canTouch) {
            ...
            o < 10 && 0 != o
                ? ((this.norClock.active = !1),
                  (this.speClock.active = this.clockWarn.active = !0),
                  (this.clockLbl2.string = o + ""),
                  (this.clockLbl2.node.x = 1 != o ? 0 : -6),
                  _sound.default.ins.play(_sound.default.TIME),
                  _vb.default.p(_vb.VEnum3.DOUBLE))
                : ((this.norClock.active = !0),
                  (this.speClock.active = this.clockWarn.active = !1),
    ...
    e.prototype.updateRaceNpcs = function (t, e) {
        ...
        if (n) {
            ...
            cc.tween(o.node)
                ...
                .start();
            cc.tween(n.node).to(s, {x: a}).start();
        }
    };
            ...
            cc.tween(s)
                ...
                .call(function () {
                    ...
                    n
                        ? (i.playLose(),
                          0 == e.heartsNum
                              ? (_sound.default.ins.play(_sound.default.LOSE), e.playAni(f.gameLose), e.eventDot(!1))
                              : (e.canTouch = !0))
                        : (e.canTouch = !0);
                })
                .start();
                ...
                switch (s.label) {
                    case 0:
                        return (
                            ...
                            (i = this.items[n]),
                            (r = i.icon),
                            (a = this[r + "Prefab"]) ? [3, 2] : [4, _res.default.ins.lPre("prefab/game/" + r)]
                        );
                    case 1:
                        (a = s.sent()), (s.label = 2);
                    case 2:
                        switch (((c = this.patices), this.curItemIdx)) {
                            case 0:
                                if (
                                    ...
                                    return l(), [2];
                                (u = cc.instantiate(a)).setPosition(t.node.position),
                                    u.setParent(c),
                                    (u.scale = 1 / this.gridBgSp.node.scale),
                                    _sound.default.ins.play(_sound.default.SHOVEL),
                                    (p = u.getComponent(cc.Animation)).play(),
                                    p.on(
                            ...
                            case 1:
                                for (
                                    d = this.random_noticeLbl.node.parent.convertToWorldSpaceAR(cc.Vec2.ZERO),
                                        c.convertToNodeSpaceAR(d, d),
                                        h = _com.default.ins.rad,
                                        f = this.grids,
                                        g = [],
                                        m = this.rows_,
                                        v = this.cols_,
                                    ...
                                    for (
                                        ...
                                        (_ && _[b]) ||
                                            !I.isEmpty ||
                                            (g.push({t: m - F - 1, e: T, data: I}), 3 != g.length));
                                        T++
                                    );
                                for (
                                    _com.default.ins.randSort(g),
                                        D = Math.min(g.length, 3),
                                        P = function (t) {
                                            var e = g[t];
                                            var o = e.t;
                                            var n = e.e;
                                            ...
                                            if (a) {
                                                ...
                                                var p = new cc.Vec2();
                                                1 == h(1, 2)
                                                    ? ((p.x = (d.x + d.y + u.x - u.y) / 2),
                                                      (p.y = (d.y + u.x + u.y - d.x) / 2))
                                                    : ((p.x = (u.x + u.y + d.x - d.y) / 2),
                            ...
                            case 2:
                                if (
                                    ...
                                    for (
                                        ...
                                        x(F);
                                a
                                    ? ((j = cc.instantiate(a)).setParent(c),
                                      (j.angle = null != o ? -90 : 0),
                                      (j.scale = 1 / this.gridBgSp.node.scale),
                                      cc
                                          .tween(j)
                                          .set({position: R})
                                          .to(1, {position: N})
    ...
    e.prototype.playAni = function (t) {
        if (!this.curAni)
            switch (((this.curAni = t), this.panelAni.play(t), t)) {
                case f.gameLose:
                    this.playDownAni(!0);
                    break;
                case f.gameRelife:
        ...
        if (this.byGuide)
            cc.tween(this.guideNpc)
                ...
                .call(function () {
                    ...
                    cc.tween(e)
                        .set({active: !0, x: 80, y: 0, scale: 1, opacity: 255})
                        .to(0.5, {scale: 1.2})
                        .to(0.5, {scale: 1}, {easing: "cubicOut"})
                        .union()
                        .repeatForever()
            ...
            (o.type != _pInfo.gameType.practice && _idx.platform.stopVideoRecord(), o.type === _pInfo.gameType.normal)
        ) {
            var i = _pInfo.default.ins.getPuzzleLvl() - 1;
            var r =
                (null ===
                    (e = null === (t = _cfgMgr.default.serverCfg.add_desktop) || void 0 === t ? void 0 : t.rules) ||
                void 0 === e
                    ? void 0
                    : e.nums) || 7;
            var a = _pInfo.default.ins.getAddDesk();
            _idx.platform.string() != _pConst.PFCode.Bytedance ||
                i != r ||
                a ||
                _panelMgr.default.ins.open("ui/ui_deskReward", null);
        }
    };
    e.prototype.playDownAni = function (t) {
        var e = t ? -360 : this.downBeginY;
        var o = t ? 0 : 1.1;
        cc.tween(this.downNode)
            .delay(o)
            .to(10 / 30, {y: e, opacity: t ? 0 : 255})
            .start();
    };
    ...
    e.prototype.GetBaseRowHeadNums = function (t) {
        if (0 == this.rowHeadNums.length)
            for (var e = this.baseData, o = this.rows_ - 1; o >= 0; o--) {
    ...
    e.prototype.GetBaseColHeadNums = function (t) {
        if (0 == this.colHeadNums.length)
            for (var e = this.baseData, o = 0; o < this.cols_; o++) {
    ...
    e.prototype.AddRowHead = function (t, e, o) {
        var n = {shineBg: null, labels: [], allRight: !1};
        ...
        if (
            ...
            (a.position = cc.v3(
                this.gridsStartX - 2,
                t * this.gridSize + this.gridSize / 2 + Math.floor(t / 5) * p - 1
            )),
            (a.parent = this.rowHintsParent),
            (n.shineBg = c),
            this.gridHeadRowVec.push(n),
            (a.scale = i),
            (e && t > this.treeData.minRow && t < this.treeData.maxRow) ||
                (o && this.iceData && this.iceData.rHints[t]))
        ) {
    ...
    e.prototype.AddColHead = function (t, e, o) {
        ...
        if (
            ((f.parent = a),
            (a.position = cc.v3(
                this.gridsStartX + t * this.gridSize + this.gridSize / 2 + Math.floor(t / 5) * h + 1,
                this.rows_ * this.gridSize + 5
            )),
            (a.parent = this.colHintsParent),
            (n.shineBg = c),
            this.gridHeadColVec.push(n),
            (a.scale = i),
            (e && t > this.treeData.minCol && t < this.treeData.maxCol) ||
                (o && this.iceData && this.iceData.cHints[t]))
        ) {
    ...
    e.prototype.TestTouch = function (t, e) {
        ...
        return i < 0 || r < 0 || r > p.height || i > p.width
            ? a
            : (i < this.gridsStartX - 15
                  ? (s = Math.floor(r / this.gridSize)) >= 0 && s < this.rows_ && ((a.area = l.HeadRow), (a.row = s))
                  : r > this.rows_ * this.gridSize + 15
                  ? (c = Math.floor((i - this.gridsStartX) / this.gridSize)) >= 0 &&
                    c < this.cols_ &&
                    ((a.area = l.HeadCol), (a.col = c))
                  : ((s = Math.floor(r / this.gridSize)),
                    (c = Math.floor((i - this.gridsStartX) / this.gridSize)),
                    s >= 0 &&
                        s < this.rows_ &&
                        c >= 0 &&
                        c < this.cols_ &&
                        ((a.area = l.Grid), (a.row = s), (a.col = c))),
              a);
    };
    e.prototype.OnTouchBegan = function (t) {
        if ((this.resetCD(), this.canTouch))
            return (
                !this.click_touch_ &&
                ((this.click_touch_ = !0),
                (this.gridTouchStart = null),
                void (
                    this.isAllRight ||
                    ((this.gridTouchStart = this.TestTouch(t)),
                    this.gridTouchStart.area == l.Grid && this.OperationStepBegin(),
                    this.gridTouchStart.area == l.Grid &&
                        ((this.touchDir = u.None),
                        (this.fillMode = p.None),
                        this.OnClickGrid(this.gridTouchStart.row, this.gridTouchStart.col)))
                ))
            );
    };
    e.prototype.OnTouchMoved = function (t) {
        if (this.canTouch && !this.isAllRight && this.gridTouchStart && this.gridTouchStart.area != l.None)
            do {
                if (this.gridTouchStart.area != l.Grid) break;
                var e = this.TestTouch(t, !0);
                if (e.area != l.Grid) break;
                if (
                    (this.touchDir == u.Horizontal
                        ? (e.row = this.lastTouchRow)
                        : this.touchDir == u.Vertical && (e.col = this.lastTouchCol),
                    e.row == this.lastTouchRow && e.col == this.lastTouchCol)
                )
                    break;
                this.touchDir == u.None &&
                    (e.row == this.lastTouchRow
                        ? (this.touchDir = u.Horizontal)
                        : e.col == this.lastTouchCol && (this.touchDir = u.Vertical));
                var o = e.row;
                var n = e.col;
    ...
    e.prototype.SetWorkGridTag = function (t, e, n, i) {
        ...
        var u = this.soundIdx;
        if (
            ((u = this.soundIdx > 15 ? 15 : this.soundIdx),
            !(l < 0 || l >= this.workData.length) &&
                this.workData[l] != t &&
                (this.OperationStepBySetWorkTag(this.workData[l], t, e * s + n), t == c.O || t == c.X))
        ) {
            var p = this.treeData;
            var d = this.wormData;
            var h = this.iceData;
            if (this.curItemBtn && !i)
                return (
                    2 == this.curItemIdx ||
                    !(!p || !p[l]) ||
                    !(!h || !h[l]) ||
                    (this.updateItemNum(this.curItemIdx, !0),
                    this.useItem(r, e, n),
            ...
            if (r.isEmpty) {
                ...
                this.tipTog &&
                    !i &&
                    ((this.tipLabel.string = u + ""),
                    1 == u
                        ? this.tipNode.setPosition(r.node.position)
                        : 2 == u
                        ? ((this.tipNode.active = !0), this.tipAni.play(g.tipIn))
                        : ((this.tipLabel.node.x = u > 9 ? -14 : -13),
                          cc.tween(this.tipNode).to(0.1, {scale: 1.1}).to(0.1, {scale: 1}).start()));
            }
        }
    };
                ...
                if (t) {
                    ...
                    if (d && d.drop) {
                        ...
                        (m.scale = v.scale),
                            ...
                            v.parent.addChild(m),
                            _res.default.ins.lSF("game/ice/pit", m.addComponent(cc.Sprite));
                        var _ = o.gridSize;
                        var b = cc.v2(v.x, v.y);
                        var S = cc.v2(b.x + _, b.y + 3 * _);
                        var T = cc.v2(b.x + 1.5 * _, b.y - 3 * _);
                        cc.tween(m).bezierTo(1, b, S, T).start(),
                            cc
                                .tween(m)
                                .delay(0.2)
                                .by(20 / 30, {scale: -0.3})
                ...
                switch (s.label) {
                    ...
                    case 7:
                        return (
                            ...
                            (T = Math.floor),
                            (I = this.lineW),
                            1 == (R = _pInfo.default.ins.getUsingSkin().bg)
                                ? [3, 10]
                                : ((N = "game/skin/" + R + "/"), [4, _res.default.ins.lSF(N + "grid")])
                        );
                    case 8:
                    ...
                    case 10:
                        for (C = 0, O = this.workData, M = O.length; C < M; C++)
                            (L = e - Math.floor(C / n) - 1),
                                (E = T((A = C % n) / 5)),
                                (x = T(L / 5)),
                                (B = r + A * a + 0.5 * a + E * I),
                                (F = L * a + 0.5 * a + x * I),
                                (V = cc.instantiate(i)).setPosition(B, F),
                                V.setScale(S, S, 1),
                                (U = c[C] = V.getComponent(_grid.default)),
                                (z = u[C]),
                                U.init(z),
                                U.initType(D, P),
                                l.addChild(V),
                                f &&
                                    ...
                                    A > p.minCol &&
                                    A < p.maxCol &&
                                    ((H = cc.instantiate(f)).setPosition(B, F),
                                    H.setScale(S, S, 1),
                                    g.addChild(H),
                                    (p[C] = H.getComponent(cc.Animation))),
                                y &&
                                    z &&
                                    ((G = d[C]),
                                    (J = G.i),
                                    (W = G.tex),
                                    (q = G.dir),
                                    ((K = cc.instantiate(y)).angle = q),
                                    K.setPosition(B, F),
                                    K.setScale(S, S, 1),
                                    K.getComponent("worm").init(W),
                                    (Y = m.children[J]).addChild(K)),
                                v &&
                                    h &&
                                    h[C] &&
                                    ((X = cc.instantiate(v)).setPosition(B, F),
                                    X.setScale(S, S, 1),
                                    ((Z = X.getComponent("ice")).r = L),
                                    (Z.c = A),
                                    (h[C] = Z),
                                    _.addChild(X));
                        return (
                            g && g.setSiblingIndex(l.childrenCount - 1),
                            m && m.setSiblingIndex(0),
                            _ && _.setSiblingIndex(l.childrenCount - 1),
    ...
    e.prototype.RefreshRowHeadState = function (t) {
        ...
        if (this.IsRowLogicRight(t)) {
            ...
            for (
                var a = this.GetBaseRowHeadNums(t),
                    s = this.GetBaseRowBeginNums(t),
                    l = this.workData,
                    u = 0,
                    p = a.length;
                u < p;
    ...
    e.prototype.RefreshColHeadState = function (t) {
        ...
        if (this.IsColLogicRight(t)) {
            ...
            for (
                var a = this.GetBaseColHeadNums(t),
                    s = this.GetBaseColBeginNums(t),
                    l = this.workData,
                    u = this.rows_,
                    p = 0,
                    d = a.length;
    ...
    e.prototype.playHightLight = function (t, e) {
        ...
        if (void 0 === e) {
            for (var a = void 0, s = void 0, l = 0; l < r; l++)
                (o = n[l + (i - t - 1) * i]).isEmpty && (o.select(c.X, !0), this.treeCheck(t, l), this.iceCheck(t, l)),
                    o.playHL(0.02 * l),
                    0 == l ? (a = o.node.position) : l == r - 1 && (s = o.node.position);
            if (a) {
            ...
            for (a = void 0, s = void 0, l = 0; l < i; l++)
                (o = n[e + l * i]).isEmpty &&
                    (o.select(c.X, !0), this.treeCheck(i - 1 - l, e), this.iceCheck(i - 1 - l, e)),
                    o.playHL(0.02 * l),
                    0 == l ? (a = o.node.position) : l == r - 1 && (s = o.node.position);
            if (a) {
            ...
            var d = void 0;
            for (l = 0; l < i; l++)
                for (var h = 0; h < r; h++) (d = 0.02 * (i - l - 1 + h)), (o = n[l + h * i]).playHL(d);
        }
    };
    ...
    e.prototype._raceRefresh = function (t, e) {
        if (this.isRefreshing) this.raceRefreshPop.push({r: t, c: e});
        else {
            this.isRefreshing = !0;
            var n = this.raceDensity;
            (this.raceRefeshTime = this.raceRefeshTime + 1) % 2 == 0 &&
                ((n = this.raceDensity - 0.05) < this.raceMinDenstiy && (n = this.raceMinDenstiy),
                (this.raceDensity = n));
            var i = this.baseData;
            var r = this.workData;
            var a = this.grids;
            ...
            for (
                ...
                for (var I = 0, D = void 0; I < 10; I++) {
                    ...
                    var k = i[x];
                    var R = r[x];
                    if ((p && (0 == k && 1 == w && b++, (w = k)), (p && D == e) || (d && T == t))) P.playFallDown();
                    else if (
                        (p
                            ? ((f && D > e) || (!f && D < e)) &&
                              (P.playWalk(a[x + g].node.position), (a[x + g] = P), (i[x + g] = k), (r[x + g] = R))
                            : d &&
                              ((y && T > t) || (!y && T < t)) &&
                              (P.playWalk(a[x + m].node.position), (a[x + m] = P), (i[x + m] = k), (r[x + m] = R)),
                        (p && 9 == I) || (d && 9 == S))
                    ) {
            ...
            if (d) {
                ...
                if (L > 4)
                    for (_ = 1, I = 0; I < 10; I++) {
                        var x;
                        var B = a[(x = I + 10 * t)];
                        if (1 == _ && 0 == B.isRight) (B.isRight = 1), (i[x] = 1), (A = !0);
                        else if (A) break;
                        _ = B.isRight;
                    }
            }
    ...
    e.prototype.OnClickGrid = function (t, e, o) {
        if (!(t < 0 || e < 0 || t >= this.rows_ || e >= this.cols_)) {
            ...
            n == c.Empty
                ...
                : n == c.O && this.pen == c.O
                ? (i = c.Empty)
                : n == c.X && this.pen == c.X && (i = c.Empty);
            (this.fillMode == p.Set && n != c.Empty) ||
                (this.fillMode == p.Clean && n == c.Empty) ||
                (-1 != i &&
                    (this.fillMode == p.None && (this.fillMode = n == c.Empty ? p.Set : p.Clean),
                    !this.SetWorkGridTag(i, t, e, o) &&
                        (this.RefreshRowHeadState(t), this.RefreshColHeadState(e), this.CheckAllRight())),
                (this.lastTouchRow = t),
                (this.lastTouchCol = e));
        }
    };
    e.prototype.OnClickRowHead = function (t) {
        if (!this.byGuide && !this.IsRowLogicRight(t)) {
            ...
            e.treeMask ||
                e.iceMask ||
                (this.curItemBtn && 2 == this.curItemIdx
                    ? (this.updateItemNum(this.curItemIdx, !0), this.useItem(null, t, null))
                    : this.showOrHideSelectMask(t),
                _vb.default.p(_vb.VEnum3.SHORT));
        }
    };
    e.prototype.OnClickColHead = function (t) {
        if (!this.byGuide && !this.IsColLogicRight(t)) {
            ...
            e.treeMask ||
                e.iceMask ||
                (this.curItemBtn && 2 == this.curItemIdx
                    ? (this.updateItemNum(this.curItemIdx, !0), this.useItem(null, null, t))
                    : this.showOrHideSelectMask(void 0, t),
                _vb.default.p(_vb.VEnum3.SHORT));
        }
    };
    e.prototype.showOrHideSelectMask = function (t, e) {
        ...
        if (void 0 === t && void 0 === e)
            (o.active = !1),
                -1 != n.row &&
                    (((m = this.gridHeadRowVec[n.row].shineBg).active = !1), cc.Tween.stopAllByTarget(m), (n.row = -1)),
                -1 != n.col &&
                    (((m = this.gridHeadColVec[n.col].shineBg).active = !1), cc.Tween.stopAllByTarget(m), (n.col = -1));
        else {
            var i = o.active;
            ...
            if (
                (i ||
                    ...
                    (o.width = o.height = u),
                    o.setPosition(p, d),
                    cc.tween(r).set({opacity: 0}).to(0.2, {opacity: 128}).start()),
                void 0 !== t)
            ) {
                ...
                if ((-1 != f && (((m = h[f].shineBg).active = !1), cc.Tween.stopAllByTarget(m)), f == t)) {
                    ...
                    (o.height = s),
                        (n.row = t),
                        (o.y = t * s + s / 2 + Math.floor(t / 5) * l - 1),
                        ((m = h[t].shineBg).active = !0),
                        cc.tween(m).to(0.8, {opacity: 0}).to(0.8, {opacity: 100}).union().repeatForever().start();
            } else {
                var y = this.gridHeadColVec;
                if (
                    ((f = n.row),
                    -1 != (g = n.col) && (((m = y[g].shineBg).active = !1), cc.Tween.stopAllByTarget(m)),
                    g == e)
                ) {
    ...
    e.prototype.CancelGridTouch = function () {
        ...
        this.click_touch_ = !1;
        this.gridTouchStart &&
            this.gridTouchStart.area != l.None &&
            ((this.gridTouchStart.area = l.None), this.OperationStepEnd());
    };
    ...
    e.prototype.winSpScaleAni = function () {
        ...
        cc.tween(t)
            .to(0.5, {scale: 1.2})
            .delay(5 / 30)
            .to(1, {scale: 0.5, x: 0, y: _global.default.padScale ? 75 : 175}, {easing: "cubicIn"})
            .call(this.PlayFireworks.bind(this))
            .by(5 / 30, {scale: 0.05}, {easing: "cubicOut"})
            .by(5 / 30, {scale: -0.05}, {easing: "cubicIn"})
            .start();
    };
    e.prototype.tilesWinAni = function () {
        ...
        cc.tween(t)
            .delay(20 / 30)
            .to(1, {scale: 0.606, x: -288, y: 100}, {easing: "cubicIn"})
            .call(this.PlayFireworks.bind(this))
            .start();
    };
    e.prototype.gameWin = function () {
        ...
        this.eventDot(!0);
        u
            ? (r = _festivalMgr.default.ins.getFesPuzzleSprFrame())
            : p ||
              d ||
              (r = c
                  ? _levelMgr.default.ins.getPuzzleSprFrame(_pInfo.default.ins.getPuzzleLvl())
                  : _levelMgr.default.ins.getPracitceSprfFrame(this.practiceId));
        ...
        if (l) {
            ...
            if (
                ((m.getChildByName("adGetBtn").active = !1),
                (m.getChildByName("nextPraBtn").active = !this.byGuide),
                this.byGuide)
            ) {
            ...
            var _ = void 0;
            d
                ? (this.unschedule(this._chaCD),
                  _challengeMgr.default.ins.winChallenge(o.challageData.date),
                  (_global.default.loadToRace = 3))
                : p
                ? ((this.levelLbl.node.parent.active = !1), (g.scaleX = 0), (_ = 15 == this.rows_))
                : ((i = c ? a.getPuzzleLvl() : _festivalMgr.default.ins.getFesPuzzleLv()),
                  (this.levelLbl.string = "" + i),
                  (_ = i % 3 == 0),
                  c ? a.finishPuzzleLvl() : _festivalMgr.default.ins.finishFesPuzzleLv());
            a.recordGameResult(s, !0, this.score, void 0, i);
            var b = {};
            if (
                ((b[
                    s !== _pInfo.gameType.festival || _festivalMgr.default.ins.isJigsawMax()
                        ? "puzzle_pieces"
                        : "newYear_pieces"
                ] = 1),
                d)
                ...
                b = (null ===
                    (e = null === (t = _cfgMgr.default.serverCfg) || void 0 === t ? void 0 : t.daily_challenge) ||
                void 0 === e
                    ? void 0
                    : e.reward) || {times: 50, coin: 100, puzzle_pieces: 10};
    ...
    e.prototype.PlayFireworks = function () {
        if (!this.byGuide) {
            ...
            _res.default.ins
                ...
                .then(function (o) {
                    t.isValid &&
                        o.load("prefab/game/banner", cc.Prefab, function (o, n) {
                            if (!o && t.isValid) {
                                var i = cc.instantiate(n);
    ...
    e.prototype.OperationStepEnd = function () {
        this.isAllRight ||
            ((this.opStep.is_row_autox_changed ||
                this.opStep.is_col_autox_changed ||
                this.opStep.is_hint_rows_changed ||
                this.opStep.is_hint_cols_changed ||
                0 != this.opStep.grids.length) &&
                (this.opStep.is_row_autox_changed || this.opStep.row_autox_cols.clear(),
                this.opStep.is_col_autox_changed || this.opStep.col_autox_rows.clear()));
    };
    e.prototype.OperationStepBySetWorkTag = function (t, e, o) {
        this.opStep.grids.push({tag_undo: t, tag_redo: e, grid: o});
    };
    ...
    e.prototype.OnBtnHelp = function () {
        this.resetCD();
        _panelMgr.default.ins.open("ui/ui_raceTip", {pageIdx: o.type == _pInfo.gameType.race ? 2 : 0});
        _vb.default.p(_vb.VEnum3.SHORT);
    };
    ...
    e.prototype.OnBtnTip = function () {
        ...
        _uData.default.ins.setSetting({tip: this.tipTog});
        this.updateTip();
        _vb.default.p(_vb.VEnum3.SHORT);
    };
    ...
    e.prototype.OnBtnHome = function () {
        ...
        _panelMgr.default.ins.open(
            "ui/ui_rePlay",
            {curScore: this.score, continueCb: this.continueCb.bind(this)},
            {MaskNoHide: !0}
        );
        _vb.default.p(_vb.VEnum3.SHORT);
    };
        ...
        _idx.platform.shareVideoRecord().then(function (e) {
            ...
            if (1 == e && o && o.isValid && o.node.active) {
                ...
                _panelMgr.default.ins.open("ui/ui_flyAni", {
                    itemDatas: [{itemId: r, worldPos: l, value: a}],
                    showCoin: c
                });
                t.shareBtn.active = !1;
            }
    ...
    e.prototype.OnBtnItem = function (t, e) {
        var n = this;
        if ((this.showOrHideSelectMask(), this.resetCD(), this.canTouch))
            if (this.curItemBtn) this.OnBtnHideItem();
            else {
                ...
                if (i.itemMax != i.itemCur) {
                    if (0 == i.count)
                        return (
                            (this.canTouch = !1),
                            this.raceChgVis(),
                            void _panelMgr.default.ins.open("ui/ui_getItem", {
                                itemId: i.icon,
    ...
    e.prototype.tmpGet = function (t) {
        ...
        if (o.type == _pInfo.gameType.challenge) {
            h = t ? this.mult : 1;
            var r = (null ===
                (n = null === (e = _cfgMgr.default.serverCfg) || void 0 === e ? void 0 : e.daily_challenge) ||
            void 0 === n
                ? void 0
                : n.reward) || {times: 50, coin: 100, puzzle_pieces: 10};
            ...
            a.length
                ? _panelMgr.default.ins.open("ui/ui_flyAni", {
                      itemDatas: a,
                      hideCb: function () {
                          _pInfo.chgScene(_pInfo.sceneType.main, {cb: i});
                      }
                  })
                : _pInfo.chgScene(_pInfo.sceneType.main, {cb: i});
        } else if (this.reward) {
            ...
            if (_rewardMgr.default.hasPendingCashReward()) {
                ...
                return void _pInfo.chgScene(_pInfo.sceneType.main, {cb: i});
            }
            
            // 💝 无现金奖励时，执行原有游戏道具奖励逻辑
            if (!t && 10 == this.mult) {
                return void _panelMgr.default.ins.open(
                    "ui/ui_getReward",
            ...
            var g;
            g =
                o.type !== _pInfo.gameType.festival || _festivalMgr.default.ins.isJigsawMax()
                    ? "puzzle_pieces"
                    : "newYear_pieces";
            ...
            _panelMgr.default.ins.open("ui/ui_flyAni", {
                itemDatas: [
                    {itemId: "coin", worldPos: T, value: y},
                    {itemId: "coin", worldPos: I, value: m},
                    {itemId: g, worldPos: D, value: v}
                ],
                hideCb: function () {
                    _pInfo.chgScene(_pInfo.sceneType.main, {cb: i});
                },
        ...
        } else _pInfo.chgScene(_pInfo.sceneType.main, {cb: i});
    };
        ...
        if (2 == this.curItemIdx) {
            ...
            this.gridHeadColVec.forEach(function (o) {
                if (!o.allRight || e) {
                    ...
                    (n.active = t),
                        t
                            ? cc.tween(n).to(0.8, {opacity: 0}).to(0.8, {opacity: 100}).union().repeatForever().start()
    ...
    e.prototype.getHeartCloseCb = function () {
        ...
        this.scheduleOnce(function () {
            ...
            _panelMgr.default.ins.open(e, {curScore: t.score}, {MaskNoHide: !0});
        }, 0.5);
    };
    ...
    e.prototype.playGirlAni = function (t) {
        t != this.curGirlAni &&
            o.type != _pInfo.gameType.race &&
            this.topGirlSk &&
            ((this.curGirlAni = t),
            (this.topGirlSk.animation = t),
            (this.topGirlSk.loop = t == h.idle) && (this.curGirlAni = null));
    };
    ...
    e.prototype.eventDot = function (t) {
        if (o.type == _pInfo.gameType.normal) {
            ...
            _idx.platform.reportEvent(_idx.ERepEvt.maindungeon, {iswin: t ? "胜利" : "失败", level: e});
        } else if (o.type == _pInfo.gameType.race) _idx.platform.reportEvent(_idx.ERepEvt.raceEnd, {score: this.score});
        else if (o.type == _pInfo.gameType.festival) {
            var n = Number(_festivalMgr.default.ins.getFesPuzzleLv());
            _idx.platform.reportEvent(_idx.ERepEvt.fesMainPuzzle, {iswin: t ? "胜利" : "失败", id: n});
        } else if (o.type == _pInfo.gameType.challenge) {
            var i = o.challageData.date;
            var r = 1e4 * i.year + 100 * i.month + i.day;
            _idx.platform.reportEvent(_idx.ERepEvt.dailyChallenge, {iswin: t ? "胜利" : "失败", time: r});
        }
    };
