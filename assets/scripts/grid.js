...
var p = (function (t) {
    ...
    e.prototype.select = function (t, e) {
        if ((void 0 === e && (e = !1), this.isEmpty)) {
            ...
            this.aniIdx = n < 2 ? 0 : 1;
            _evts.default.opE.emit({action: _evts.default.UPDATESCORE});
            e ||
                (1 != n && 2 != n) ||
                _evts.default.opE.emit({action: _evts.default.LOSEHEART, data: this.node.position});
        }
    };
    ...
    e.prototype.playItemTip = function (t) {
        if (this.isEmpty) {
            ...
            e.active = t;
            t
                ? this.scheduleOnce(this.tipShine, 2 * Math.random())
                : (this.itemTipAni.stop(), (this.itemTipNode.opacity = 0));
        }
    };
    ...
    e.prototype.playShow = function (t) {
        cc.tween(this.node)
            .delay((6 * (Math.random() + 1.5)) / 60)
            .to(0.1, {scale: t + 0.2})
            .to(0.05, {scaleX: t - 0.1, scaleY: t - 0.3})
            .to(0.05, {scaleX: t + 0.1, scaleY: t + 0.1})
            .to(0.05, {scale: t})
            .start();
    };
    e.prototype.playFallDown = function () {
        var t = this;
        cc.tween(this.node)
            .by(0.1, {angle: 60 * Math.random() - 30})
            .to(1, {y: -1e3}, {easing: "quadOut"})
            .call(function () {
                t.node.destroy();
            })
            .start();
    ...
    e.prototype.playWalk = function (t) {
        var e = this.node;
        var o = e.scale;
        var n = cc.tween(e).to(0.1, {position: t});
        var i = cc
            .tween(e)
            .to(0.05, {scale: o - 0.4}, {easing: "cubicOut"})
            .to(0.1, {scale: o}, {easing: "cubicIn"});
        cc.tween(e)
            .delay((6 * (Math.random() + 0.5)) / 60)
            .parallel(n, i)
            .start();
    };
