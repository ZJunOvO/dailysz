...
var l = (function(t) {
    ...
    e.prototype.init = function() {
        ...
        _uData.default.ins.syncLaunchOption({ query: e });
        this.initListener();
    };
    e.prototype.initListener = function() {
        var t = this;
        cc.game.on(cc.game.EVENT_SHOW, function() {
            Math.abs(Date.now() / 1e3 - t.onHideT) > 300 ?
                t.syncTime().then(function(t) {
                    t && _time.default.ins.sync(t), _evts.default.plE.emit({ onShow: !0 });
                }) :
                _evts.default.plE.emit({ onShow: !0 });
        });
    ...
    e.prototype.login = function() {
        return Promise.resolve({ code: "dev_ceshi" });
    };
