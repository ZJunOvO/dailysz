...
exports.sceneType = {loading: "loading", main: "main", game: "game", guide: "guide"};
(function (t) {
    (t[(t.normal = 0)] = "normal"),
        (t[(t.race = 1)] = "race"),
        (t[(t.challenge = 2)] = "challenge"),
        (t[(t.practice = 3)] = "practice"),
        (t[(t.festival = 4)] = "festival"),
        (t[(t.freedom = 5)] = "freedom");
...
exports.chgScene = function (t, e) {
    ...
    var c = cc.director;
    exports.ROOT = t;
    t == exports.sceneType.game
        ? (s = _.default.type = s || r.normal) == r.challenge && (_.default.challageData = e.challengeData || {})
        : (delete _.default.type, delete _.default.challageData, _levelMgr.default.ins.clearPrcitceId());
    s == r.freedom && (_global.default.freedomSize = e.freedomSize || 10);
    var l = function () {
        null == n || n();
    };
    if (i) c.loadScene(t, l);
    else {
...
var w = (function () {
    function t() {
        this.isOpenLock = !0;
        this.recordData = {
            main: {gTimes: 0, wTimes: 0, heWins: 0, tPoints: 0, hePoints: 0},
            daily: {gTimes: 0, wTimes: 0, heWins: 0, tPoints: 0, hePoints: 0, feTime: 0},
            race: {gTimes: 0, tPoints: 0, hePoints: 0, feTime: 0}
        };
        this.uploadData = {
            ttMScore: 0,
            ttDScore: 0,
        ...
        this.usingSkin = {bg: 1, role: 1, headFrame: 1, nameFrame: 1};
    }
    ...
    t.prototype.setLevel = function (t) {
        _uData.default.ins.setLocalData({lvl: t});
    };
    t.prototype.finishLvl = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function () {
                return [2, {data: {lvl: this.getLevel() + 1}}];
            });
        });
    };
    ...
    t.prototype.setGuideDone = function () {
        _uData.default.ins.setLocalData({guideDone: 1});
    };
    ...
    t.prototype.setPuzzleLvl = function (t) {
        _uData.default.ins.setLocalData({puzzleLvl: t});
    ...
    t.prototype.setJisawLvl = function (t) {
        _uData.default.ins.setLocalData({jisawLvl: t});
    };
    t.prototype.finishJisawLvl = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function () {
                return [2, {data: {lvl: this.getJisawLvl() + 1}}];
            });
        });
    };
    ...
    t.prototype.addCoin = function (t, e) {
        if ((void 0 === e && (e = !0), !isNaN(t))) {
            ...
            o < 0 && (o = 0);
            this.setCoin(o);
            e && _evts.default.opE.emit({action: _evts.default.COIN_CHG});
        }
    };
    t.prototype.setCoin = function (t) {
        _uData.default.ins.setLocalData({coin: t});
    };
    t.prototype.getlevel = function () {
    ...
    t.prototype.addLevel = function (t) {
        if ((void 0 === t && (t = 1), !isNaN(t))) {
            ...
            e < 0 && (e = 0);
            _uData.default.ins.setLocalData({level: e});
            _evts.default.opE.emit({action: _evts.default.LEV_CHG});
        }
    };
    t.prototype.addExp = function (t) {
        if (!isNaN(t)) {
            ...
            _uData.default.ins.setLocalData({exp: e});
            _evts.default.opE.emit({action: _evts.default.EXP_CHG});
        }
    };
    ...
    t.prototype.addPower = function (t, e) {
        if ((void 0 === e && (e = !0), !isNaN(t))) {
            ...
            e && _evts.default.opE.emit({action: _evts.default.POWER_CHG});
        }
    };
    t.prototype.setPower = function (t) {
        t != this.getPower() && (t < 0 && (t = 0), _uData.default.ins.setLocalData({power: t}));
    };
    ...
    t.prototype.setPowerFullTime = function (t) {
        _uData.default.ins.setLocalData({powerFullTime: t});
    };
    ...
    t.prototype.recordGameResult = function (t, e, o, n, i) {
        ...
        if (t === r.normal) {
            ...
            e
                ? ((u.wTimes = Number(u.wTimes) + 1),
                  this.winMainLevel(),
                  (u.heWins = u.heWins > this.getConsWinTimes() ? u.heWins : this.getConsWinTimes()),
                  this.getLuckyState() || (0 == Number(u.wTimes) % 2 && this.setLuckState(!0)))
                : this.setConsWinTimes(0);
            u.tPoints = Number(u.tPoints) + o;
            u.hePoints = u.hePoints > o ? u.hePoints : o;
            this.setTodayMainScore(this.getTodayMainScore() + o);
            null != i &&
                (null === (a = _idx.platform.setFriendRankData) ||
                    void 0 === a ||
                    a.call(_idx.platform, i, _pConst.SDKConfig.ttZoneId.normal));
        } else if (t === r.challenge) {
            var p = this.getRecordDailyData();
            e
                ? ((p.wTimes = Number(p.wTimes) + 1),
                  this.winDailyLevel(),
                  (p.heWins = p.heWins > this.getDailyWinTimes() ? p.heWins : this.getDailyWinTimes()))
                : this.setDailyWinTimes(0);
            ...
            null === (l = _idx.platform.setFriendRankData) ||
                void 0 === l ||
                l.call(_idx.platform, d.hePoints, _pConst.SDKConfig.ttZoneId.race);
    ...
    t.prototype.setRecordData = function (t) {
        _uData.default.ins.setLocalData({recordData: t});
    };
    ...
    t.prototype.setConsWinTimes = function (t) {
        _uData.default.ins.setLocalData({mConsWTimes: t});
    };
    ...
    t.prototype.setDailyWinTimes = function (t) {
        _uData.default.ins.setLocalData({dConsWTimes: t});
    };
    ...
    t.prototype.setTodayMainScore = function (t) {
        _uData.default.ins.setLocalData({tdMScore: t});
    };
    ...
    t.prototype.setTodayMainWin = function (t) {
        _uData.default.ins.setLocalData({tdMWin: t});
    };
    ...
    t.prototype.setTodayDailyScore = function (t) {
        _uData.default.ins.setLocalData({tdDScore: t});
    };
    ...
    t.prototype.setTodayDailyWin = function (t) {
        _uData.default.ins.setLocalData({tdDWin: t});
    };
    ...
    t.prototype.setTodayRaceScore = function (t) {
        t > this.getTodayRaceScore() &&
            (_uData.default.ins.setLocalData({tdRScore: t}), _rankMgr.default.ins.uploadRaceData());
    };
    t.prototype.chgTodayRaceScore = function (t) {
        _uData.default.ins.setLocalData({tdRScore: t});
    };
    ...
    t.prototype.setYdayRaceScore = function (t) {
        _uData.default.ins.setLocalData({ydRScore: t});
    };
    ...
    t.prototype.setLuckyTimes = function (t) {
        _uData.default.ins.setLocalData({luckyTimes: t});
    };
    ...
    t.prototype.setLuckState = function (t) {
        _uData.default.ins.setLocalData({luckyState: t});
    };
    ...
    t.prototype.setPowerAdTimes = function (t) {
        _uData.default.ins.setLocalData({powerAdTimes: t});
    };
    ...
    t.prototype.setCoinAdTimes = function (t) {
        _uData.default.ins.setLocalData({coinAdTimes: t});
    };
    ...
    t.prototype.setTicketAdTimes = function (t) {
        _uData.default.ins.setLocalData({ticketAdTimes: t});
    };
    ...
    t.prototype.setLastUploadRankData = function (t) {
        _uData.default.ins.setLocalData({lastUploadRank: t});
    };
    ...
    t.prototype.setYdayRaceRankData = function (t) {
        _uData.default.ins.setLocalData({ydayRRData: t});
    };
    ...
    t.prototype.setRankLastTimeData = function (t) {
        _uData.default.ins.setLocalData({rLastTime: t});
    };
    ...
    t.prototype.setIsGetSlider = function (t) {
        _uData.default.ins.setLocalData({isSlider: t});
    };
    ...
    t.prototype.setAliAddHome = function (t) {
        _uData.default.ins.setLocalData({aliAddHome: t});
    };
    ...
    t.prototype.setFirstRaceTip = function (t) {
        _uData.default.ins.setLocalData({isRaceTip: t});
    };
    ...
    t.prototype.setNormalShareTime = function (t) {
        _uData.default.ins.setLocalData({norShareT: t});
    };
    ...
    t.prototype.setRaceShareTime = function (t) {
        _uData.default.ins.setLocalData({raceShareT: t});
    };
    ...
    t.prototype.setJigsawAdTimes = function (t) {
        _uData.default.ins.setLocalData({jigsawAdTimes: t});
    };
    ...
    t.prototype.setNewJigAdTimes = function (t) {
        _uData.default.ins.setLocalData({newJigAdTimes: t});
    };
    ...
    t.prototype.setAdCount = function (t) {
        _uData.default.ins.setLocalData({adCount: t});
    };
    t.prototype.addAdCount = function () {
        var t = this.getAdCount();
        this.setAdCount(t + 1);
        this.isMaxAdCount() &&
            (_idx.platform.reportEvent(_idx.ERepEvt.adMax), _evts.default.opE.emit({action: _evts.default.AD_MAX}));
    };
    t.prototype.isMaxAdCount = function () {
        return (
            void 0 !== _cfgMgr.default.serverCfg.daily_max_ad_times.val &&
            this.getAdCount() >= _cfgMgr.default.serverCfg.daily_max_ad_times.val
        );
    };
    ...
    t.prototype.setShareCount = function (t) {
        _uData.default.ins.setLocalData({shareCount: t});
    };
    ...
    t.prototype.setJigsawBgEndTimes = function (t) {
        _uData.default.ins.setLocalData({jigEndTimes: t});
    };
    ...
    t.prototype.setNewJigBgEndTimes = function (t) {
        _uData.default.ins.setLocalData({newJigEndTimes: t});
    };
    ...
    t.prototype.setIsClearJigsawData = function (t) {
        _uData.default.ins.setLocalData({isClearJig1: t});
    };
    ...
    t.prototype.setIsCheckdLock = function (t) {
        _uData.default.ins.setLocalData({isCheckdLock: t});
    };
    ...
    t.prototype.setIsOpenLocked = function (t) {
        _uData.default.ins.setLocalData({localIsOpen: t});
    };
    ...
    t.prototype.isMianLocked = function () {
        ...
        var i =
            (null ===
                (o =
                    null === (e = null === (t = _cfgMgr.default.serverCfg) || void 0 === t ? void 0 : t.lock_rules) ||
                    void 0 === e
                        ? void 0
                        : e.main_line_lock) || void 0 === o
                ? void 0
                : o.main_line_val) || 0;
    ...
    t.prototype.setIsGetNewGif = function (t) {
        _uData.default.ins.setLocalData({isGetNewGift: t});
    };
    ...
    t.prototype.setHasFinJig = function (t) {
        _uData.default.ins.setLocalData({hasFinJig: t});
    ...
    t.prototype.setHasFinFesJig = function (t) {
        _uData.default.ins.setLocalData({hasFinFesJig: t});
        _uData.default.ins._setLocalAndCloudData();
    };
    ...
    t.prototype.setFesName = function (t) {
        _uData.default.ins.setLocalData({fesName: t});
    };
    ...
    t.prototype.setFesPro = function (t) {
        _uData.default.ins.setLocalData({fesPro: t});
    };
    ...
    t.prototype.setFesTaskPro = function (t) {
        _uData.default.ins.setLocalData({fesTaskPro: t});
    };
    ...
    t.prototype.setFesPuzzleLv = function (t) {
        _uData.default.ins.setLocalData({fesPuzzleLv: t});
    };
    ...
    t.prototype.setShareNames = function (t) {
        _uData.default.ins.setLocalData({sNames: t});
    };
    ...
    t.prototype.setChallengeData = function (t) {
        _uData.default.ins.setLocalData({chaData: t});
    };
    ...
    t.prototype.setChallengePackData = function (t) {
        _uData.default.ins.setLocalData({chaPackData: t});
    };
    ...
    t.prototype.setAddDesk = function (t) {
        _uData.default.ins.setLocalData({addDesk: t});
    };
    ...
    t.prototype.setJigTiles = function (t) {
        _uData.default.ins.setLocalData({jigTiles: t}, 15);
    };
    ...
    t.prototype.setSevenDays = function (t) {
        _uData.default.ins.setLocalData({sevenLogin: t});
    };
    ...
    t.prototype.setSevenReward = function (t) {
        _uData.default.ins.setLocalData({sevenReward: t});
    };
    ...
    t.prototype.setShopRecord = function (t) {
        _uData.default.ins.setLocalData({shopRecord: t});
    };
    ...
    t.prototype.setShopUnreset = function (t) {
        _uData.default.ins.setLocalData({shopReUn: t});
    };
    Object.defineProperty(t.prototype, "Bag", {
        ...
        set: function (t) {
            t && _uData.default.ins.setLocalData({bag: t});
        },
        enumerable: !1,
        configurable: !0
    });
    Object.defineProperty(t.prototype, "Mail", {
        ...
        set: function (t) {
            t && _uData.default.ins.setLocalData({mail: t});
        },
        enumerable: !1,
        configurable: !0
    });
    Object.defineProperty(t.prototype, "mySkin", {
        get: function () {
            this._mySkin || (this._mySkin = {bg: [1], role: [1], headFrame: [1], nameFrame: [1]});
            return this._mySkin;
        },
        enumerable: !1,
        configurable: !0
