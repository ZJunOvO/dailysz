...
var g = (function (t) {
    ...
    e.prototype.open = function (t, e, o) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (s) {
                switch (s.label) {
                    case 0:
                        return o.inQueue && this.panelList.length > 0
                            ? (this.panelQueue.push({prefab: t, data: e, opt: o}), [2, {panelResult: c.WAITING}])
                            : [3, 1];
                    case 1:
                        return [
                            4,
                    ...
                    case 2:
                        return (
                            ...
                            cc.isValid(n)
                                ? ((i = cc.instantiate(n)),
                                  (r = i.getComponent(_baseUI.default))
                                      ? (((a =
                                            i.getComponent(cc.Widget) || i.addComponent(cc.Widget)).verticalCenter = 0),
                                        (a.horizontalCenter = 0),
                                        (a.isAlignVerticalCenter = !0),
                                        (a.isAlignHorizontalCenter = !0),
                                        (this.currentPanel = i),
                                        this.panelList.push({prefab: t, data: e, opt: o, node: i}),
                                        i.setParent(this.container),
                                        r.show(e),
                                        this.ensureMask(),
                                        _evts.default.laE.emit({comp: r}),
                                        [
                                            2,
                                            new Promise(function (t) {
                                                r.setCb(function (e, o) {
                                                    ...
                                                    t({panelResult: c.DONE, values: o});
                                                    d.onNext();
                                                    d.scheduleOnce(function () {
                                                        d.ensureMask();
                                                        _evts.default.laE.emit({comp: null});
                                                    }, 0);
                                                });
                                            })
                                        ])
                                      : (console.warn("failed to load component of prefab", t),
                                        [2, {panelResult: c.FAILED}]))
                                : (console.warn("invalid prefab", t), [2, {panelResult: c.FAILED}])
                        );
                    case 3:
                        return [2];
                }
    ...
    e.prototype.ensureMask = function () {
        ...
        if (e <= 0)
            (i.opacity = 0),
                i.isValid && (i.active = !1),
                _evts.default.opE.emit({action: _evts.default.CHECK_WX_BTNS});
        else {
            var r = o.node;
            i.active = !0;
            cc.tween(i).to(0.2, {opacity: 200}).start();
            r.active = !0;
            i.setSiblingIndex(n);
            r.setSiblingIndex(n);
            _evts.default.opE.emit({action: _evts.default.HIDE_WX_BTNS});
        }
    };
