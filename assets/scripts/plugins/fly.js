        ...
        function (t) {
            ...
            t.exports = {
                ...
                formatParams: function (t) {
                    ...
                    return this.isObject(t)
                        ? ((function t(i, r) {
                              ...
                              else if ("object" == s) for (var c in i) t(i[c], r ? r + "%5B" + a(c) + "%5D" : a(c));
                ...
                merge: function (t, e) {
                    for (var o in e)
                        t.hasOwnProperty(o)
                            ? this.isObject(e[o], 1) && this.isObject(t[o], 1) && this.merge(t[o], e[o])
                            : (t[o] = e[o]);
                    return t;
                }
            };
        ...
        function (t, e, o) {
                            ...
                            var h = new Promise(function (l, h) {
                                ...
                                function y(o) {
                                    ...
                                    if ((t || !a || n || (t = location.href), 0 !== t.indexOf("http"))) {
                                        ...
                                        if (
                                            ("/" !== n[n.length - 1] && (n += "/"), (t = n + (u ? t.substr(1) : t)), a)
                                        ) {
                                    ...
                                    for (var I in (r.trim((S || "").toLowerCase()) === T
                                        ? (e = r.formatParams(e))
                                        : r.isFormData(e) ||
                                          -1 === ["object", "array"].indexOf(r.type(e)) ||
                                          ((T = "application/json;charset=utf-8"), (e = JSON.stringify(e))),
                                    S || v || (o.headers[s] = T),
                                    o.headers))
                                        if (I === s && r.isFormData(e)) delete o.headers[I];
                                        else
                                            try {
                                    ...
                                    i.onload = function () {
                                        try {
                                            ...
                                            t &&
                                                o.parseJson &&
                                                -1 !== (i.getResponseHeader(s) || "").indexOf("json") &&
                                                !r.isObject(t) &&
                                                (t = JSON.parse(t));
                                            ...
                                            var a = i.status;
                                            var c = i.statusText;
                                            var l = {data: t, headers: e, status: a, statusText: c};
                                            if ((r.merge(l, i._response), (a >= 200 && a < 300) || 304 === a))
                                                (l.engine = i), (l.request = o), D(p.handler, l, 0);
                                            else {
                                                var u = new k(c, a);
                                                (u.response = l), P(u);
                                            }
            ...
            ["get", "post", "put", "patch", "head", "delete"].forEach(function (t) {
                s.prototype[t] = function (e, o, n) {
                    return this.request(e, o, r.merge({method: t}, n));
                };
            });
