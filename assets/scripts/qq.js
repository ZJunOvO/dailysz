...
var c = (function (t) {
    ...
    e.prototype.doWatchAD = function () {
        var t = this;
        return this.noAd
            ? (_evts.default.adE.emit(_c.ADE.VIDEO_END), Promise.reject(_pConst.VideoFailCode.NO_AD))
            : this.noVideo
            ? void Promise.reject(_pConst.VideoFailCode.NO_AD)
            : (_evts.default.adE.emit(_c.ADE.VIDEO),
              this.showLoading(),
              new Promise(function (e, o) {
                  var n = wx.createRewardedVideoAd({adUnitId: "bb8f5f005098f1ca2e16e73448b4bc8c"});
                  n.onError(function () {});
                  n.onLoad(function () {});
                  n.onClose(function t(i) {
                      null != n && n.offClose(t),
                          null != i && i.isEnded
                              ? (_evts.default.adE.emit(_c.ADE.VIDEO_END), e(1))
                              : (_evts.default.adE.emit(_c.ADE.VIDEO_END), o(_pConst.VideoFailCode.CANCELED));
                  });
                  n.load()
                      .then(function () {
                          n.show()
