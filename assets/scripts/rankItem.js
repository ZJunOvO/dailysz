...
var h = (function (t) {
    ...
    e.prototype.setHeadSp = function (t) {
        var e = this;
        t
            ? cc.assetManager.loadRemote(t, {ext: _global.headImgExt}, function (t, o) {
    ...
    e.prototype.setSkin = function (t, e, o) {
        ...
        void 0 === o && (o = !1);
        t
            ? (t.headFrame && 1 != t.headFrame
                  ? _skinMgr.default.ins.updateHeadFrame(t.headFrame, this.headFSp, !0)
                  : _skinMgr.default.ins.updateHeadFrame(1, this.headFSp, !0),
              t.nameFrame && 1 != t.nameFrame
                  ? _skinMgr.default.ins.updateNameFrame(t.nameFrame, this.nameFSp)
                  : (this.nameFSp.spriteFrame = null))
            : (_skinMgr.default.ins.updateHeadFrame(1, this.headFSp, !0), (this.nameFSp.spriteFrame = null));
    };
    ...
    e.prototype.clickHead = function () {
        this.game_uid &&
            _panelMgr.default.ins.open("ui/ui_userInfo", {gameUid: this.game_uid, baseData: this.rankInfo});
    };
