...
var g = (function (t) {
    ...
    e.prototype.initInfo = function () {
        if (this.nowHaveTime) (this.btn_start.enabled = !0), (this.labTip.node.active = !1);
        else {
    ...
    e.prototype.addGoodToData = function (t, e) {
        ...
        _panelMgr.default.ins.open("ui/ui_flyAni", {itemDatas: [{itemId: t.props, worldPos: o, value: t.val}]});
    };
    e.prototype.playAni = function (t, e, o) {
        var n = this;
        if (!this.isCurPlayAni) {
            if (((this.isCurPlayAni = !0), !e))
                return (
                    this.actionIndex(t), (this.pointerNode.angle = -this.pointRots[t]), void (this.isCurPlayAni = !1)
                );
            var i = t;
            var r = 0;
            var a = function () {
