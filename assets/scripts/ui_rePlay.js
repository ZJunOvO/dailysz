...
var w = (function (t) {
    ...
    e.prototype.init = function (t) {
        ...
        i == _pInfo.gameType.race &&
            ((m = "当前积分:"),
            (v = "最高积分:"),
            (_ = e),
            (b = r.getRecordData().race.hePoints || 0),
            (d = p.qw_line.val),
            (f = p.qw_line.props));
        this.curLb.string = m;
        this.preLb.string = v;
            ...
            .then(function (e) {
                ...
                if (1 == e && o && o.isValid && o.node.active) {
                    ...
                    if (n) {
                        ...
                        (s = c.main_line.val),
                            (a = c.main_line.props),
                            (u = i.getNormalShareTime()),
                            i.setNormalShareTime(u + 1);
                    switch (a) {
                        case "coin":
                    ...
                    _panelMgr.default.ins.open("ui/ui_flyAni", {
                        itemDatas: [{itemId: a, worldPos: d, value: s}],
                        showCoin: r
                    });
                    t.shareBtn.active = !1;
                }
    ...
    e.prototype.hideThis = function () {
        ...
        t == _pInfo.gameType.race
            ? ((_global.default.loadToRace = 4),
              _festivalMgr.default.ins.updPro(_festivalMgr.fesTaskKey.raceScore, this.curScore))
            : t == _pInfo.gameType.challenge && (_global.default.loadToRace = 3);
        t != _pInfo.gameType.practice
            ? (_pInfo.default.ins.recordGameResult(_game.default.type, !1, this.curScore),
              _pInfo.chgScene(_pInfo.sceneType.main, {cb: void 0}))
