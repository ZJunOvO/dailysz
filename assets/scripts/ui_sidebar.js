...
var g = (function (t) {
                ...
                n.loadDir("platform/" + o, cc.SpriteFrame, function (o, n) {
                    !o &&
                        ...
                        n.forEach(function (o) {
                            if (-1 !== o.name.indexOf("txt"));
                            else if (-1 !== o.name.indexOf("exa"))
                                if (cc.sys.platform === cc.sys.BYTEDANCE_GAME)
                                    (e = cc.v3(0, 90, 0)),
                                        (t.exampleSpr.spriteFrame = o),
                                        (t.exampleSpr.node.position = e);
                                else if (cc.sys.platform === cc.sys.ALIPAY_GAME)
                                    if (((e = cc.v3(-132, 35, 0)), -1 !== o.name.indexOf("exa1")))
                                        (t.exampleSpr.spriteFrame = o), (t.exampleSpr.node.position = e);
                                    else {
                                        var n = new cc.Node();
    ...
    e.prototype.updateSliderStatus = function () {
        ...
        _pInfo.default.ins.getIsGetSlider()
            ? ((this.getBtn.active = !1), (this.intoBtn.active = !1), (this.tipNode.active = !0))
    ...
    e.prototype.onGet = function () {
        ...
        _panelMgr.default.ins.open("ui/ui_flyAni", {
            itemDatas: [{itemId: "coin", worldPos: e, value: 20}],
            hideCb: function () {
                t.hideThis();
