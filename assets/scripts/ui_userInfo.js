...
var g = (function (t) {
    ...
    e.prototype.init = function (t) {
        ...
        n == c.getUid()
            ? ((p = c.getName()),
              (d = c.getHeadImg()),
              (r.recordData = JSON.parse(JSON.stringify(l.getRecordData()))),
              (r.jigFin = l.getHasFinJig()),
              (r.mySkin = l.getMySkin()),
              (r.uSkin = l.getUsingSkin()),
              this.rePanel(r))
            : (i &&
                  ((p = i.nickname),
                  (d = i.avatar),
                  (r.uSkin = null === (e = null == i ? void 0 : i.extra_data) || void 0 === e ? void 0 : e.usingSkin)),
              _request.default.ins.getUserDataByUid(n).then(function (t) {
                  if (t && o.node && o.node.isValid) {
                      var e = t.data;
                      e &&
                          ((r.recordData = null == e ? void 0 : e.recordData),
                          (r.jigFin = null == e ? void 0 : e.hasFinJig),
    ...
    e.prototype.rePanel = function (t) {
        ...
        if (t) {
            ...
            this.headTxt.string =
                (null === (a = null === (r = null == t ? void 0 : t.mySkin) || void 0 === r ? void 0 : r.headFrame) ||
                void 0 === a
                    ? void 0
                    : a.length) || 1;
            this.bgTxt.string =
                (null === (c = null === (s = null == t ? void 0 : t.mySkin) || void 0 === s ? void 0 : s.bg) ||
                void 0 === c
                    ? void 0
                    : c.length) || 1;
            this.nameTxt.string =
                (null === (p = null === (u = null == t ? void 0 : t.mySkin) || void 0 === u ? void 0 : u.nameFrame) ||
                void 0 === p
                    ? void 0
                    : p.length) || 1;
            this.roleTxt.string =
                (null === (h = null === (d = null == t ? void 0 : t.mySkin) || void 0 === d ? void 0 : d.role) ||
                void 0 === h
                    ? void 0
                    : h.length) || 1;
            this.lsTxt.string =
                (null === (g = null === (f = null == t ? void 0 : t.recordData) || void 0 === f ? void 0 : f.main) ||
                void 0 === g
                    ? void 0
                    : g.heWins) || 0;
            this.raceScoreTxt.string =
                (null === (m = null === (y = null == t ? void 0 : t.recordData) || void 0 === y ? void 0 : y.race) ||
                void 0 === m
                    ? void 0
                    : m.hePoints) || 0;
            this.normalScoreTxt.string =
                (null === (_ = null === (v = null == t ? void 0 : t.recordData) || void 0 === v ? void 0 : v.main) ||
                void 0 === _
                    ? void 0
                    : _.tPoints) || 0;
            var D = 0;
