...
var _ = (function (t) {
    ...
    e.prototype.initVersion = function () {
        ...
        this.version =
            ...
            (null === (e = null === (t = wx.getAccountInfoSync()) || void 0 === t ? void 0 : t.miniProgram) ||
            void 0 === e
                ? void 0
                : e.version);
    };
    ...
    e.prototype.initWechatListener = function () {
        ...
        wx.onShow(function (e) {
            _sound.default.ins.playBGM(),
                ...
                t._share_callback && t._share_callback();
        });
        wx.onHide(function () {
        ...
        this.canUse("2.0.2") ||
            ("qq" === this.getSystemData().AppPlatform &&
                    ...
                    o && o.code
                        ? (
                              ...
                              (_idx.platform.cloud =
                                  wx.cloud &&
                                  wx.cloud.init &&
                                  (wx.cloud.init({env: ""}), (_idx.platform.cloud = wx.cloud)))
                          ).callFunction({
                              name: "gOpenId",
                              success: function (e) {
                                  var n = e.result;
    ...
    e.prototype.initCloud = function () {
        return new Promise(function (t) {
            wx.login({
                success: function () {
                    var e;
                    (null === (e = wx.cloud) || void 0 === e ? void 0 : e.init) &&
                        ((_idx.platform.cloud = wx.cloud.init({env: ""})),
    ...
    e.prototype.getCloudData = function () {
        ...
        var e =
            _idx.platform.cloud ||
            (_idx.platform.cloud =
                wx.cloud && wx.cloud.init && (wx.cloud.init({env: ""}), (_idx.platform.cloud = wx.cloud)));
        if (e) {
            var o = e.database();
            if (o) {
            ...
            return __generator(this, function (a) {
                switch (a.label) {
                    ...
                    case 1:
                        ...
                        (e.isSaving = !0),
                            (i = n.collection("userData")),
                            (r = Promise.resolve()),
                            e.isCheck || (r = this._check(i)),
                            r
                                .then(function () {
                                    e.dbId
                                        ? i
                                        ...
                                        : i.add({data: {uData: t}}).then(function (t) {
                ...
                if (!this.noAd) {
                    if (!this.noVideo)
                        return (
                            ...
                            (o = _adC.VEnum[null !== (e = t.videoDuration) && void 0 !== e ? e : 30]),
                            this.preloadVideo(o)
                                ? null == (n = this.videoMap[o])
                                    ? (_evts.default.adE.emit(_c.ADE.VIDEO_END),
                                      [2, Promise.reject(_pConst.VideoFailCode.NO_AD)])
                                    : (this.showLoading(),
                                      (i = this),
                                      [
                                          2,
                                          new Promise(function (t, e) {
                                              n.onClose(function o(i) {
                                                  null != n && n.offClose(o),
                                                      null != i && i.isEnded
                                                          ? (_evts.default.adE.emit(_c.ADE.VIDEO_END), t(1))
                                                          : (_evts.default.adE.emit(_c.ADE.VIDEO_END),
                                                            e(_pConst.VideoFailCode.CANCELED));
                                              });
                                              n.show()
                                                  .then(function () {})
                                                  .catch(function () {
    ...
    e.prototype.vibrate = function (t) {
        t == _pConst.VEnum4.SHORT ? wx.vibrateShort({type: "medium"}) : t == _pConst.VEnum4.LONG && wx.vibrateLong();
    };
    e.prototype.preloadVideo = function (t) {
        ...
        if (!e && (null == o || n - o >= _pConst.SDKConfig.videoCoolTime)) {
            ...
            if (null == i) {
                var r = this;
                i = wx.createRewardedVideoAd({adUnitId: t, multiton: !0});
                this.videoMap[t] = i;
                i.onLoad(function () {
    ...
    e.prototype.PostMessage = function (t, e, o) {
        wx.getOpenDataContext().postMessage({Even: t, Value1: e, Value2: o});
    };
    ...
    e.prototype.share = function () {
        ...
        return new Promise(function (e) {
            ...
            wx.shareAppMessage({title: o.title, imageUrl: o.imageUrl, query: o.query});
        ...
        this.canUse("2.32.1") &&
            wx.getSetting({
                ...
                success: function (t) {
                    ...
                    ((!n && !o) || (n && "accept" != n.SYS_MSG_TYPE_INTERACTIVE)) &&
